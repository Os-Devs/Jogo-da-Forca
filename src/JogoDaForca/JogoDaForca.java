...
public class JogoDaForca {
    ...
    public JogoDaForca(String nomearquivo) throws Exception{
        ...
        //subir e while já montava
        //formatad text field, diz o que quer q difite, lá msm resolve
        //pd tirar terminou , ou colocr lá fora
        //coloca exceção primeiro
        //desabilitar botão
    ...
    public String getPalavra() { return this.tracoPalavra.toString().toUpperCase();}
